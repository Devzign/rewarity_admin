...
// Admin menu customized for Rewarity
const adminMenu = [
  { label: "Dashboard", link: "/dashboard/sales", icon: "ri-layout-grid-line" },
  {
    label: "User Management",
    icon: "ri-team-line",
    submenu: [
      { label: "Users", link: "/admin/users" },
      { label: "User Types", link: "/admin/user-types" },
      { label: "User Roles", link: "/admin/roles" },
      { label: "Map Users", link: "/admin/map-users" }
    ]
  },
  { label: "Products", link: "/admin/products", icon: "ri-shopping-bag-line" },
  { label: "Colors", link: "/admin/colors", icon: "ri-palette-line" },
  { label: "Categories", link: "/admin/categories", icon: "ri-price-tag-3-line" },
  { label: "Orders & Purchases", link: "/admin/orders", icon: "ri-shopping-cart-2-line" }
];
...
export { adminMenu, applicationsMenu, pagesMenu, uiElementsMenu };
