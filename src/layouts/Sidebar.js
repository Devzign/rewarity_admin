                ...
                <div className="sidebar-footer">
                    <div className="sidebar-footer-top">
                        ...
                        <div className="sidebar-footer-body">
                            {(() => { const u = getUser(); return (
                                <>
                                  <h6><Link to="/pages/profile">{u?.userName || 'Guest'}</Link></h6>
                                  <p>{u?.email || 'Not signed in'}</p>
                                </>
                            ); })()}
                        </div>
                    ...
                    <div className="sidebar-footer-menu">
                        ...
                        <nav className="nav">
                            ...
                            <Link to="" onClick={this.handleLogout}><i className="ri-logout-box-r-line"></i> Log Out</Link>
                        </nav>
                    </div>
                </div>
            </div>
        ...
        return (
            <React.Fragment>
                <div className="nav-group show">
                    <div className="nav-label" onClick={this.toggleMenu}>Menu</div>
